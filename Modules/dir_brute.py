...
-Website Directory Bruteforce-
"""
print cprint(banner, "yellow")

tgturl = str(raw_input("Enter Target URL: "))
wdlist = str(raw_input("Enter a wordlist file: "))
thds = int(raw_input("Enter Threads (Normal 50): "))

threads = thds  # Be aware that a large number of threads can cause a denial of service!!!
target_url = tgturl
wordlist_file = wdlist
